...
Il est important de faire la normalisation des données pour éviter la sur-domination des variables à grande variance, par exemple : Tot_OcNoDecana ayant pour 3Q - 1Q = 560 >> B avec 3Q - 1Q = 71. J'ai donc scale de manière linéaire toutes les variables.
...
# Plan factoriel des individus (PROPRE)
plot.PCA(res_correct, 
         choix = "ind", 
         label = "quali",  
         title = "Projection (corrigée) des individus sur le plan (1,2)")

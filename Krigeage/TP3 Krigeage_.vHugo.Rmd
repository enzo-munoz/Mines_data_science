...
```
 Que des variables entre 0 et 1 de moyenne proche de 0.5. équivalent à tiré d'une loi uniforme dans [0,1]
...
train_df2 <- data.frame(Y = Ytrain, Xtrain[,c(1,2,4,5)])ù
...
Il semble toujours y avoir une tendance mais la moyenne est nulle donc on peut utiliser du krigeage simple. Le krigeage ordinaire aurait plus d'incertitude spatiale qui est dû à l'estimation de la moyenne du processus. 
